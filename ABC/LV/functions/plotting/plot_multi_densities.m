...
for i=1:3
    ...
    [~,density,xmesh,~] = kde(S_rej(:, i), den(1,1), 0, lim(i)); plot(xmesh, density, 'LineWidth', 1, 'Color',rgb('Black'), 'DisplayName', 'Reference');
    for j=1:nalgs
        [~,density1,xmesh1,~] = kde(R_in{j}(:, i), den(2,1), 0, lim(i)); plot(xmesh1, density1, 'Color',col{j}, 'DisplayName', names{j});
    end
