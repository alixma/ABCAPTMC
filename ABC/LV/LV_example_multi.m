...
if(acf_plots)
    ...
    fprintf(' %.3f |', mean(iat.anytime./iat.stdexchange));
    fprintf(' larger on average than ABC-PTMC-1 \n');
    
    fprintf('ABC-PTMC-W has IAT: \n') ;
    fprintf(' %.3f |', mean(iat.stdexchange./iat.stdexchangem));
    fprintf(' smaller on average than ABC-PTMC-1 \n');
    fprintf(' %.3f |', mean(iat.anytime./iat.stdexchangem));
    fprintf(' smaller on average than ABC-APTMC-1 \n');
    
    fprintf('ABC-APTMC-W has IAT: \n') ;
    fprintf(' %.3f |', mean(iat.stdexchange./iat.anytimem));
    fprintf(' smaller on average than ABC-PTMC-1 \n');
    fprintf(' %.3f |', mean(iat.anytime./iat.anytimem));
    fprintf(' smaller on average than ABC-APTMC-1 \n');
    fprintf(' %.3f |', mean(iat.stdexchangem./iat.anytimem));
    fprintf(' smaller on average than ABC-PTMC-W \n');
    
    % COMPARE ESS %
    fprintf('ABC-APTMC-1 has ESS: \n') ;
    fprintf(' %.3f |', mean(ess.anytime./ess.stdexchange));
    fprintf(' larger on average than ABC-PTMC-1 \n');
    
    fprintf('ABC-PTMC-W has ESS: \n') ;
    fprintf(' %.3f |', mean(ess.stdexchangem./ess.stdexchange));
    fprintf(' larger on average than ABC-PTMC-1 \n');
    fprintf(' %.3f |', mean(ess.stdexchangem./ess.anytime));
    fprintf(' larger on average than ABC-APTMC-1 \n');
    
    fprintf('ABC-APTMC-W has ESS: \n') ;
    fprintf(' %.3f |', mean(ess.anytimem./ess.stdexchange));
    fprintf(' larger on average than ABC-PTMC-1 \n');
    fprintf(' %.3f |', mean(ess.anytimem./ess.anytime));
    fprintf(' larger on average than ABC-APTMC-1 \n');
    fprintf(' %.3f |', mean(ess.anytimem./ess.stdexchangem));
    fprintf(' larger on average than ABC-PTMC-W \n');
...
if(time_plots)
    ...
    time_interval = [max(params.T-300, 0) params.T]; %[0 min(300, params.T)]; %
